...
(function(){
    ...
    var _s = {
        ...
        /**
         * Given instance, try to coerce it to type
         * */
    ...
    var depricatedAlias = function (funName, oldName) {
        _s[oldName] = function () {
            if (typeof console != 'undefined' && typeof console.log != 'undefined')
                console.log(
                    'Deprecation warning: use "' + funName + '" instead "' + oldName + '". ' +
 ...
 */
 ...
 a.event.special.notext.handler)},teardown:function(){a(this).unbind("textchange",a.event.special.notext.handler)},handler:function(b,c){a(this).val()===""&&a(this).val()!==c&&a(this).trigger("notext")}}})(jQuery);//      index.js
//
